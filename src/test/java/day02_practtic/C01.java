...
public class C01 {
    ...
    public void test() throws InterruptedException {
        ...
        WebElement ddm = driver.findElement(By.cssSelector("[id='dropdown']"));
        ...
        String sectigimOptionValeo = select.getFirstSelectedOption().getText();
        System.out.println("SECTİGİM OPTİON VALEO: " + sectigimOptionValeo);
        Thread.sleep(3000);
